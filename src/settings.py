...
# OS type
def get_os():
    """Return OS type string: 'windows', 'nix', or 'unknown' for use in path/executable logic."""
    os_name = system()
    if os_name == "Windows":
        return "windows"
    elif os_name == "Darwin":
...
## Dates
defaults["START_DATE"] = datetime.strptime("2025-01-01", "%Y-%m-%d")
...
def create_directories():
    """Create DATA_DIR and OUTPUT_DIR from config if they do not exist."""
